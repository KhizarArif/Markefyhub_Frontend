            ...
            <section className="w-[90vw] md:w-[95vw] px-20 mx-auto py-10">
                <div className="space-y-4">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-[#1f1f1f] leading-snug">
                        The Impact of Technology on the Workplace: <br className="hidden md:block" />
                    ...
                    <div className="w-full rounded-lg overflow-hidden mt-4">
                        <Image src="/asd1.jpg" alt="Main Building" width={1600} height={800} className="w-full h-auto object-cover" />
                    </div>
                    ...
                    <div className="mt-4">
                        <h3 className="font-bold text-3xl md:text-xl text-[#1f1f1f] mb-2">Research Your Destination</h3>
                        <p className="text-[#444] text-2xl md:text-xl leading-relaxed">
            ...
            <section className="w-[90vw] md:w-[95vw] mx-auto px-20 py-10">
                <div className="space-y-6">
                    ...
                    <div className="w-full rounded-lg overflow-hidden">
                        <Image src="/asd2.jpg" alt="Traveler with suitcase" width={1600} height={800} className="w-full h-auto object-cover" />
                    </div>
                </div>
            </section>
